import { useState, useRef, useEffect } from "react";
        ...
        const [ digital, setDigital ] = useState([
            ...
            { name : "노트북", code : 1070000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "노트북액세서리", code : 1080000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "멀티미디어장비", code : 1090000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "모니터", code : 1100000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "모니터주변기기", code : 1110000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "생활가전", code : 1120000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "소프트웨어", code : 1130000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "영상가전", code : 1140000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "음향가전", code : 1150000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "이미용가전", code : 1160000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "자동차기기", code : 1170000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "저장장치", code : 1180000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "주방가전", code : 1190000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "주변기기", code : 1200000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "카메라/캠코더용품", code : 1210000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "태블릿PC", code : 1220000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "태블릿PC액세서리", code : 1230000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "학습기기", code : 1240000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "휴대폰", code : 1250000, parentname:"디지털/가전", parentcode: 1000000 },
            { name : "휴대폰액세서리", code : 1260000, parentname:"디지털/가전", parentcode: 1000000 },
        ]);
        ...
        const [ seasonElectronics, setWeatherElectronics ] = useState([
        ...
        const [ opticalDevices, setOpticalDevices ] = useState([
        ...
        const [ notebookAcc, setNotebookAcc ] = useState([
        ...
        const [ videoElectronics, setVideoElectronics ] = useState([
        ...
        const [ soundElectronics, setSoundElectronics ] = useState([
        ...
        const [ beautyElectronics, setBeautyElectronics ] = useState([
        ...
        const [ carDevices, setCarDevices ] = useState([
        ...
        const [ kitchenElectronics, setKitchenElectronics] = useState([
        ...
        const [ tabletPC, setTabletPC] = useState([]);
        const [ tabletPCAcc, setTabletPCAcc] = useState([
        ...
        const [ learningDevices, setLearningDevices] = useState([
        ...
        const [ mobilePhoneAcc, setMobilePhoneAcc] = useState([
        ...
        // 카테고리 세번째
        const [ cable1394, setCable1394] = useState([
        ...
        const [ mainboard, setmMainboard] = useState([
        ...
        const [ interfaceCard, setInterfaceCard] = useState([
        ...
        const [ usbAcc, setUsbAcc] = useState([
        ...
        const [ gamePeripheral, setGamePeripheral] = useState([
        ...
        const [ coldFan, setColdFan] = useState([
        ...
        const [ airConditionerPer, setAirConditionerPer] = useState([
        ...
        const [ airHeater, setAirHeater] = useState([
        ...
        const [ electricHitPad, setElectricHitPad] = useState([
        ...
        const [ electricHitBlanket, setElectricHitBlanket] = useState([
        ...
        const [ dehumidifier, setDehumidifier] = useState([
        ...
        const [ internetModem, setInternetModem] = useState([
        ...
        const [ noteBookfilm, setNoteBookfilm] = useState([
        ...
        const [ PCSpeaker, setPCSpeaker] = useState([
        ...
        const [ videoRCVeq, setVideoRCVeq] = useState([
        ...
        const [ videoEDTcard, setVideoEDTcard] = useState([
        ...
        const [ mouthCleaner, setMouthCleaner] = useState([
        ...
        const [ steamIron, setSteamIron] = useState([
        ...
        const [ walkieTalkie, setWalkieTalkie] = useState([
        ...
        const [ videoHomeAcc , setVideoHomeAcc ] = useState([
        ...
        const [ projecterPer , setProjecterPer ] = useState([
        ...
        const [ MP3PMP , setMP3PMP ] = useState([
        ...
        const [ earphoneAcc , setEarphoneAcc ] = useState([
        ...
        const [ cassettePlayer , setCassettePlayer ] = useState([
        ...
        const [ razorSupplies , setRazorSupplies ] = useState([
        ...
        const [ frontRearCamera , setFrontRearCamera ] = useState([
        ...
        const [ carAudio , setCarAudio ] = useState([
        ...
        const [ emptyMedia , setEmptyMedia ] = useState([
        ...
        const [ kimchiRefrigerator , setKimchiRefrigerator ] = useState([
        ...
        const [ riceCooker , setRiceCooker ] = useState([
        ...
        const [ dedicatedRefrigerator , setDedicatedRefrigerator ] = useState([
        ...
        const [ compoundPrinter , setCompoundPrinter ] = useState([
        ...
        const [ compoundPrinterSupplies , setCompoundPrinterSupplies ] = useState([
        ...
        const [ tabletAcc , setTabletAcc ] = useState([
        ...
        const [ LCDfilm , setLCDfilm ] = useState([
        ...
        const [ lensRelated , setLensRelated ] = useState([
        ...
        const [ batteryCharger , setBatteryCharger ] = useState([
        ...
        const [ cameraRelated , setCameraRelated ] = useState([
        ...
        const [ cameraBag , setCameraBag ] = useState([
        ...
        const [ cameraStrap , setCameraStrap ] = useState([
        ...
        const [ flimRelated , setflimRelated ] = useState([
        ...
        const [ flimCamera , setFlimCamera ] = useState([
        ...
        const [ tabletPCfilm , setTabletPCfilm ] = useState([
        ...
        const [ learningAcc , setLearningAcc ] = useState([
        ...
        const [ phoneFlim , setPhoneFlim ] = useState([
        ...
        const [ phoneCharger , setPhoneCharger ] = useState([
