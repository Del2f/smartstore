...
function Home(props: Props) {
      ...
      <>
        ...
        <div className="panel-wrap flex-col-6 flex-col-md-12 flex-order-md-5 flex-order-xs-5">
          <div className="panel panel-dashboard">
            <div className="panel-heading">
              <div className="pull-left">
                <h3 className="panel-title">매출 통계</h3>
              </div>
              <div className="pull-right">
                <span className="sub-text">최근 20:51</span>
                <span className="refresh_Btn">
        ...
        <div className="panel-wrap flex-col-6 flex-col-md-12 flex-order-md-10 flex-order-xs-10">
          <div className="panel panel-dashboard">
            <div className="panel-heading">
              <div className="pull-left">
                <h3 className="panel-title">상품</h3>
              </div>
              <div className="pull-right">
                <span className="sub-text">최근 20:51</span>
                <span className="refresh_Btn">
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await axios.get("/smartstore/home", { withCredentials: true });
  ...
  useEffect(() => {
    const countStatuses = () => {
      ...
      orders.forEach(order => {
        const updateLength = order.update.length;
        switch (updateLength) {
          case 1:
  ...
  const showOrders = (type: number) => {
    console.log(type);
    navigate('/home/orders', { state: { type }});
    return;
  }
          ...
          <div className="SellerSubcontents">
            <div className="salesinfo">
              <div className="panel panel-dashboard">
                ...
                <div className="panel-body column flex">
                  <div className="list-wrap deposit-list">
                    <div className="salestats">
                      <ul className="panel-list">
                        <li className="text-box" onClick={() => showOrders(0)}>
                          <span className="info-title">주문 접수</span>
                          <div className="number-area">
                            <a className="number">{counts.received}</a>
                            <span>건</span>
                          </div>
                        </li>
                        <li className="text-box" onClick={() => showOrders(1)}>
                          <li className="panel-sub-info">
                            <span className="info-title">처리중</span>
                            <div className="number-area">
                              <span className="number">{counts.processing}</span>
                              <span>건</span>
                            </div>
                          </li>
                        </li>
                  ...
                  <div className="list-wrap delivery-list">
                    <div className="salestats">
                      <ul className="panel-list">
                        <li className="text-box" onClick={() => showOrders(2)}>
                          <span className="info-title">출고 준비중</span>
                          <div className="number-area">
                            <span className="number">{counts.preparing}</span>
                            <span>건</span>
                          </div>
                        </li>
                        <li className="text-box" onClick={() => showOrders(3)}>
                          <span className="info-title">출고됨</span>
                          <div className="number-area">
                            <span className="number">{counts.shipped}</span>
                            <span>건</span>
                          </div>
                        </li>
                        <li className="text-box" onClick={() => showOrders(4)}>
                          <span className="info-title">배송중</span>
                          <div className="number-area">
                            <span className="number">{counts.delivering}</span>
                            <span>건</span>
                          </div>
                        </li>
                      </ul>
