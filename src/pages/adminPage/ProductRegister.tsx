...
function ProductRegister() {
                    ...
                    try {
                        ...
                        if (product.category2.name){
                            ...
                            const result = second.filter((element:any) => 
                                element.parentcode == product.category1.code
                            )   
                        ...
                        if (product.category3.name){
                            ...
                            const result = third.filter((element:any) => 
                                element.parentcode == product.category2.code
                            )   
                            setShowThird(result);
                        }
                        ...
                        if (product.category4.name){
                            ...
                            const result = fourth.filter((element:any) => 
                                element.parentcode == product.category3.code
                            )   
    ...
    return (
        ...
        <form method='post' onSubmit={(e) => handleSubmit(e)}>
            <div className={ menu.isShowMenu == true ? "seller-content seller-content-hide" : "seller-content" }>
                        ...
                        <div className="content">
                            <div className="product-register-area">
                                <ul className="product-register-list">
                                    <li className="product-register-item">  {/* 카테고리 */}
                                    ...
                                    <li className="product-register-item"> {/* 상품명 */}
                                                ...
                                                <div className="input-area">
                                                    <div className="input-box" ref={inputRefName}>
                                                        <div id={ inputClick && inputClickNumber == 1 ? "input-inner-active" : "input-inner"}>
                                                            <input type="text" name="name" placeholder="상품명" className="input" value={Name}
                                                                onClick={() => { setInputClick(true); setInputClickNumber(1);}} onChange={NameHandler}/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li className="product-register-item"> {/* 판매가 */}
                                                ...
                                                <div className="input-area">
                                                    <div className="input-box" ref={inputRefPrice}>
                                                        <div id={ inputClick && inputClickNumber == 2 ? "input-inner-active" : "input-inner"}>
                                                            <input type="text" maxLength={10} name="productprice" placeholder="숫자만 입력" className="input" value={Price}
                                                                onClick={() => { setInputClick(true); setInputClickNumber(2);}} onChange={PriceHandler}/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li className="product-register-item"> {/* 옵션 */}
                                                        ...
                                                        <div className="input-area">
                                                            <div className="input-box" ref={inputRefOptionName}>
                                                                ...
                                                                <div id={ inputClick && inputClickNumber === 3 ? "input-inner-active" : "input-inner"}>
                                                                    <input type="text" maxLength={10} name="productOptionName" placeholder="예시 : 컬러" className="input" value={OptionName}
                                            ...
                                            <div className="input-item">
                                                <div className="input-area">
                                                    <div className="input-box" ref={inputRefDelivery}>
                                                        <div id={ inputClick && inputClickNumber == 3 ? "input-inner-active" : "input-inner"}>
                                                            <input type="text" maxLength={10} name="productDelivery" placeholder="숫자만 입력" className="input" value={Delivery}
