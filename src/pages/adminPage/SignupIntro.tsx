        ...
        <div className="layout-inner">
          <div className="signup-content">
            ...
            <div className="signup-desc">
              ...
              <strong>네이버 커머스 ID 하나</strong>로 편리하게 이용할 수 있어요.
            </div>
            <div className="signup-notice">※ 네이버 커머스 ID에 회원가입 완료 후, 개별 서비스 가입이 진행됩니다.</div>
            ...
            <div className="signup-btn-area">
              ...
              <div className="signup-subnotice">
                <span className="signup-subnotice-text">이미 네이버 커머스 ID 회원이신가요?</span>
                <a href="{() => false}" className="signup-subnotice-signup">
            ...
            <ul className="signup-notice-list">
              ...
              <li className="signup-notice-list-item">
                구매자의 개인 정보를 조회할 수 있는 서비스에 로그인할 경우, 계정 도용 시 구매자 개인 정보 보호 등을 위하여 2단계 인증 절차가 필수로
                진행됩니다.
              </li>
            </ul>
          </div>
