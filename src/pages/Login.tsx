...
//                       <li
//                         className={inputClick && inputClickNumber === 1 ? "login-item login-item-active" : "login-item"}
...
//                       </li>
//                       <li
//                         className={inputClick && inputClickNumber === 2 ? "login-item login-item-active" : "login-item"}
//                         onMouseEnter={mouseEnter}
//                         onMouseLeave={mouseLeave}
//                       >
//                         <input
